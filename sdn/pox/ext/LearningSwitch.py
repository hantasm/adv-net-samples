...
"""
Write a simple pox program that initially broadcasts all traffic, but learns which MACs are associated with each port as it receives packets.

Don't just copy one of the existing solutions.
"""
...
class LearningSwitch (object):
  """
  A LearningSwitch object is created for each switch that connects.
